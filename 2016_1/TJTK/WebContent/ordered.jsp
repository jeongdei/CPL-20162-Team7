...
function getTextByClone( tag ){  
  ...
  <!------ TABLE SORTING javascript -- end -->  
  	...
  	<thead>
    	<tr>
           <th class="name" style="text-align:center">이름<button class="btn" style="background-color:#FAF8EE; font-size:10px; width:4px; padding-left:0px"  onclick="sortTD(0)">▲</button><button class="btn" style="background-color:#FAF8EE; font-size:10px; width:4px; padding-left:0px" onclick="reverseTD(0)">▼</button></th>
    	   ...
    	   <th class="check" style="text-align:center">상태<button class="btn" style="background-color:#FAF8EE; font-size:10px; width:4px; padding-left:0px" onclick="sortTD(3)">▲</button><button class="btn" style="background-color:#FAF8EE; font-size: 10px; width: 4px; padding-left: 0px" onclick="reverseTD(3)" >▼</button></th>
        </tr>
    </thead>
  <tbody>
  			<%
    ...
    <tr>
      ...
      <td style="text-align:center; color:#ffffff; background-color:rgba(255,0,4,1.00); width:20%; margin-bottom:20px">도착</td>
    </tr>
    <%
				}
			%>
