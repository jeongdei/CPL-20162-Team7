    ...
    <div>
      ...
      <div class="input-group"><span class="input-group-addon">즐겨찾기 이름</span>
        ...
        <input type="submit" name="submit" value="삭제" class="btn btn-danger" 
        	   style="height: 100%; margin-left: -10px; margin-right: -10px; margin-bottom: -15px; margin-top: -18px; padding-bottom: 20px; font-size:12px; border-color:rgba(217,83,79,1.00);">
        </span></div></form>
        <hr>
        <div>
    <div align="center">
