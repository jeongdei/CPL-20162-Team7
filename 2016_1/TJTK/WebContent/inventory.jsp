...
<div id ="Shopping_Cart" class="Loop js-loop" style="width:100%; height:500px; overflow:auto" align="center">
	<table id="cart" class="sortable" style="width:100%; height:500px; overflow:auto; " border="0"  align="center">
		<thead>
    	<tr>
			 ...
			 <th class="number" style="text-align:center">들어온 갯수<button class="btn" style="background-color:#FAF8EE; font-size:10px; width:4px; padding-left:0px" onclick="sortTD(2)">▲</button><button class="btn" style="background-color:#FAF8EE; font-size:10px; width:4px; padding-left:0px"  onclick="reverseTD(2)">▼</button></th>
             <th class="number" style="text-align:center">보유 갯수<button class="btn" style="background-color:#FAF8EE; font-size:10px; width:4px; padding-left:0px" onclick="sortTD(3)">▲</button><button class="btn" style="background-color:#FAF8EE; font-size:10px; width:4px; padding-left:0px"  onclick="reverseTD(3)">▼</button></th>
             <th class="button" style="text-align:center; width:60px"></th>
        </tr>
     	</thead>
		<tbody>
			<%
			...
			<tr id="Test<%=ids%>" class="test" style="height:100px;">
				<td style="text-align: center"><%=ids%></td>
				<td style="text-align: center"><%=name%></td>
				<td style="text-align: center"><input type="number" style="width: 60px" value="<%=stock_count%>"></td>
				<td style="text-align:center"><input type="number" style="width:60px"></td>
				<td style="text-align:center"><button class="btn btn-block" onclick="" style="background-color:#E69B9C; margin-bottom:5px; width:60px; color:#fff">+Box</button></td>
			</tr>
			<%
				}
			%>
...
<script src="js/bootstrap.js" type="text/javascript"></script></body>
<script type="text/javascript">
